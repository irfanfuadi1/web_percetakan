                ...
                <form action="{{ route('customers.update', $customer) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" id="code"
                            ...
                            value="{{ old('code', $customer->code) }}" placeholder="Contoh: CUST001">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ old('name', $customer->name) }}" placeholder="Masukkan nama pelanggan">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="customer_type" id="customer_type"
                            ...
                            <option value="Umum"
                                {{ old('customer_type', $customer->customer_type) === 'Umum' ? 'selected' : '' }}>
                                Umum
                            </option>
